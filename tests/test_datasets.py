...
from data_acquisition.datasets import *  # noqa: F403
...
@pytest.mark.parametrize(
    "split,num_sample", [("train", 1443899), ("test", 360975), ("competition", 97320)]
)
...
@pytest.mark.parametrize(
    "split,num_sample", [("train", 5091), ("test", 1273), ("competition", 2728)]
)
...
@pytest.mark.parametrize(
    "split,num_sample", [("train", 4863), ("test", 1216), ("competition", 476)]
)
...
@pytest.mark.parametrize("split,num_sample", [("train", 18788), ("test", 4698)])
def test_women_clothing_review(split, num_sample):
    df = WomenClothingReview(split).data
    assert len(df) == num_sample


@pytest.mark.parametrize("split,num_sample", [("train", 18316), ("test", 4579)])
...
@pytest.mark.parametrize(
    "split,num_sample", [("train", 1186028), ("test", 296507), ("competition", 693359)]
)
...
@pytest.mark.parametrize("split,num_sample", [("train", 22662), ("test", 5666)])
...
@pytest.mark.parametrize(
    "split,num_sample", [("train", 15841), ("test", 3961), ("competition", 6601)]
)
...
@pytest.mark.parametrize(
    "split,num_sample", [("train", 4989), ("test", 1248), ("competition", 1560)]
)
...
@pytest.mark.parametrize(
    "split,num_sample", [("train", 37951), ("test", 9488), ("competition", 31626)]
)
